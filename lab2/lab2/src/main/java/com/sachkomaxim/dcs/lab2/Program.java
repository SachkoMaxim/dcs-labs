package com.sachkomaxim.dcs.lab2;
...
public class Program {
    ...
    public static final Lock wLock = new ReentrantLock();
    public static final Lock ALock = new ReentrantLock();
    public static final Lock MGLock = new ReentrantLock();
    public static final Lock QLock = new ReentrantLock();
    public static final Lock RLock = new ReentrantLock();
    public static final Lock SLock = new ReentrantLock();
    public static final Lock MZMELock = new ReentrantLock();
    public static final Lock MCMTwLock = new ReentrantLock();
    ...
    static class ComputingRunnable implements Runnable {
        ...
        private void partialMultiplyVectorAndMatrix(double[] vector, double[][] matrix, double[] result, Lock MultVectAndMtrxLock) {
    ...
    public static void main(String[] args) {
        try {
            ...
            saveAndPrintResults(A, MG, OUTPUT_FILE);
