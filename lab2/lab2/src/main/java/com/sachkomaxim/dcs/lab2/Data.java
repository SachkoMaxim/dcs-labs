...
public class Data implements Serializable {
    public static final String INPUT_FILE = "input.bin"; // Для порівняльних тестувань з увімкненим та вимкненим TSX
    //public static final String INPUT_FILE = "../../lab1/lab1/input.bin"; // Для порівняння з Лабораторною роботою 1
    ...
    private static double getRandomDouble(Random random) {
        ...
        double coefficient = 1 + random.nextDouble() * 9;
